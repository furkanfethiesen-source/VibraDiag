...
- 📅 **Çalıştırma zamanı:** `2026-09-02T13:17:39`
...
| :--- | :--- | :---: | :---: |
| **Child Chunk** | `det_child_recall` | **0.8042** | 🟢 ⭐⭐⭐⭐⭐ |
| **Child Chunk** | `det_child_precision` | **0.4250** | 🟠 ⭐⭐⭐☆☆ |
| **Child Chunk** | `det_child_hit_rate` | **1.0000** | 🟢 ⭐⭐⭐⭐⭐ |
| **Child Chunk** | `det_child_mrr` | **0.8750** | 🟢 ⭐⭐⭐⭐⭐ |
| **Child Chunk** | `det_child_ndcg` | **0.7355** | 🟡 ⭐⭐⭐⭐☆ |
| **Parent Chunk** | `det_parent_recall` | **1.0000** | 🟢 ⭐⭐⭐⭐⭐ |
| **Parent Chunk** | `det_parent_precision` | **0.5208** | 🟠 ⭐⭐⭐☆☆ |
| **Parent Chunk** | `det_parent_hit_rate` | **1.0000** | 🟢 ⭐⭐⭐⭐⭐ |
| **Parent Chunk** | `det_parent_mrr` | **0.8750** | 🟢 ⭐⭐⭐⭐⭐ |
| **Parent Chunk** | `det_parent_ndcg` | **0.8977** | 🟢 ⭐⭐⭐⭐⭐ |
...
| :--- | :--- | :---: | :---: |
| **Generation** | `faithfulness` | **0.7327** | 🟡 ⭐⭐⭐⭐☆ |
| **Generation** | `answer_relevancy` | **0.8702** | 🟢 ⭐⭐⭐⭐⭐ |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **standards** | **0.9449** | **1.0000** | **1.0000** | **1.0000** | **0.7039** | **0.4000** | **0.6667** | **1.0000** | **1.0000** | **1.0000** | **0.5000** | **1.0000** | **0.0000** | **0.8947** | **1.0000** |
| **signal_processing** | **0.9189** | **1.0000** | **1.0000** | **0.5000** | **0.4776** | **0.4000** | **0.6667** | **1.0000** | **0.5000** | **0.6309** | **0.3333** | **1.0000** | **0.0000** | **0.7391** | **0.5889** |
| **unbalance** | **0.9565** | **1.0000** | **1.0000** | **0.5000** | **0.3869** | **0.2000** | **0.5000** | **1.0000** | **0.5000** | **0.6309** | **0.5000** | **1.0000** | **0.0000** | **0.9500** | **0.5889** |
| **misalignment** | **0.7922** | **1.0000** | **1.0000** | **1.0000** | **0.9060** | **0.6000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **0.0000** | **0.7895** | **1.0000** |
| **looseness** | **0.7941** | **1.0000** | **1.0000** | **1.0000** | **0.8772** | **0.4000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **0.3333** | **1.0000** | **0.0000** | **0.4500** | **0.7500** |
| **resonance** | **0.8883** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **0.4000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **0.5000** | **1.0000** | **0.0000** | **0.6800** | **0.8875** |
| **flow_hydrodynamic** | **0.7249** | **1.0000** | **1.0000** | **1.0000** | **0.8772** | **0.4000** | **1.0000** | **1.0000** | **1.0000** | **1.0000** | **0.3333** | **1.0000** | **0.0000** | **0.8095** | **0.8056** |
| **bearing_fault** | **0.9423** | **1.0000** | **1.0000** | **1.0000** | **0.6548** | **0.6000** | **0.6000** | **1.0000** | **1.0000** | **0.9197** | **0.6667** | **1.0000** | **0.0000** | **0.5484** | **0.4167** |
...
| `q_020` | Rulman arızalarının gelişme aşamalarında (Sta... | `bearing_fault` | **✅ Başarılı** | `text_parent_39, text_parent_27` | `text_parent_27, text_parent_31, text_parent_39` | 🟢 5 chunk |
